	...
	int flags, int width, int precision, int size)
{
	...
	return (pat_handle_write_char(c, buffer, flags, width, precision, size));
}
/************************* PRINT A STRING *************************/
/**
 * pat_print_string - Prints a string
 * @types: List a of arguments
 * @buffer: Buffer array to handle print
 * @flags:  Calculates active flags
 * @width: get width.
...
/************************* PRINT PERCENT SIGN *************************/
/**
 * pat_print_percent - Prints a percent sign
	...
	int flags, int width, int precision, int size)
{
	...
	n = pat_convert_size_number(n, size);
...
/************************* PRINT BINARY *************************/
/**
 * pat_print_binary - Prints an unsigned number
 * @types: Lista of arguments
 * @buffer: Buffer array to handle print
 * @flags:  Calculates active flags
 * @width: get width.
